<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
          ...
          <li class="active"><a class="nav-link" href="blank.html"><i class="fas fa-square"></i> <span>Blank Page</span></a></li>
          <li class="nav-item dropdown">
          ...
          <li class="nav-item dropdown">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-file-alt"></i> <span>Forms</span></a>
            <ul class="dropdown-menu">
